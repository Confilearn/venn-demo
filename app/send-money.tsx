            ...
            >
              ...
              <View style={styles.confirmRow}>
                ...
                <Text
                  style={[
                    styles.confirmValue,
                    { color: colors.success, fontFamily: "DMSans_500Medium" },
                  ]}
                >
                  Free
                </Text>
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: insets.top + 10 + webTop }]}>
        ...
        >
          <Feather
            name={
              step === "recipient" || step === "success" ? "x" : "arrow-left"
            }
            size={24}
            color={colors.text}
          />
          ...
          {[1, 2, 3].map((i) => (
            <View
              ...
              style={[
                ...
                {
                  backgroundColor:
                    i <= (step === "recipient" ? 1 : step === "amount" ? 2 : 3)
                      ? colors.primary
                      : colors.border,
                  flex: 1,
                },
