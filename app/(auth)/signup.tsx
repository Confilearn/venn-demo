    ...
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: colors.background }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={[styles.container, { paddingTop: insets.top + 40 + webTop, paddingBottom: insets.bottom + 20 }]} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: colors.text, fontFamily: 'DMSans_700Bold' }]}>Create Account</Text>
          <Text style={[styles.subtitle, { color: colors.textSecondary, fontFamily: 'DMSans_400Regular' }]}>Start managing your finances with Venn</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View>
            <Text style={[styles.label, { color: colors.textSecondary, fontFamily: 'DMSans_500Medium' }]}>Full Name</Text>
            <View style={[styles.inputContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              <Feather name="user" size={18} color={colors.textTertiary} />
              <TextInput style={[styles.input, { color: colors.text, fontFamily: 'DMSans_400Regular' }]} placeholder="Jordan Mitchell" placeholderTextColor={colors.textTertiary} value={name} onChangeText={setName} autoCapitalize="words" />
            </View>
          </View>
          <View>
            ...
            <View style={[styles.inputContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              <TextInput style={[styles.input, { color: colors.text, fontFamily: 'DMSans_400Regular' }]} placeholder="name@company.com" placeholderTextColor={colors.textTertiary} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
            </View>
          </View>
          <View>
            ...
            <View style={[styles.inputContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              <TextInput style={[styles.input, { color: colors.text, fontFamily: 'DMSans_400Regular' }]} placeholder="Min. 6 characters" placeholderTextColor={colors.textTertiary} value={password} onChangeText={setPassword} secureTextEntry={!showPassword} />
          ...
          <Pressable
            ...
            disabled={loading}
          >
            {loading ? <ActivityIndicator color="#fff" /> : <Text style={[styles.buttonText, { fontFamily: 'DMSans_600SemiBold' }]}>Create Account</Text>}
          </Pressable>
        </View>

        <View style={styles.footer}>
          <Text style={[styles.footerText, { color: colors.textSecondary, fontFamily: 'DMSans_400Regular' }]}>Already have an account?</Text>
          <Pressable onPress={() => router.back()}>
            <Text style={[styles.footerLink, { color: colors.primary, fontFamily: 'DMSans_600SemiBold' }]}>Sign In</Text>
          </Pressable>
        </View>
      </ScrollView>
