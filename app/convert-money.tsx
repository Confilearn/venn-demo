    ...
    return (
      <View style={[styles.screen, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.successContainer}>
          ...
          >
            {formatCurrency(parseFloat(amount), fromCurrency.code)} converted to{" "}
            {formatCurrency(convertedAmount, toCurrency.code)}
          </Text>
          <Pressable
            style={({ pressed }) => [
              styles.btn,
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.swapContainer}>
          ...
          >
            1 {fromCurrency.code} ={" "}
            {(toCurrency.rate / fromCurrency.rate).toFixed(4)} {toCurrency.code}
          </Text>
        </View>
        ...
        <Pressable
          style={({ pressed }) => [
            ...
            {
              backgroundColor:
                amount && parseFloat(amount) > 0 ? colors.primary : colors.card,
              opacity: pressed ? 0.9 : 1,
            },
          ]}
